/*
 * BONK BLUEY VARIANT - FAN ART DISCLAIMER
 * 
 * This variant is FAN-MADE content created for educational and recreational purposes only.
 * Bluey™ and all related characters are trademarks of Ludo Studio Pty Ltd.
 * 
 * This code is not affiliated with, endorsed by, or sponsored by Ludo Studio,
 * the Australian Broadcasting Corporation (ABC), or BBC Studios.
 * 
 * Created by Daisy (age 9) as a learning project.
 * No copyright infringement is intended.
 * 
 * FOR PERSONAL, NON-COMMERCIAL, EDUCATIONAL USE ONLY.
 */
...
void updateScoreDisplay() {
  ...
  String gamePrefix = (gameVariant == BONK_CHICKEN) ? "BONK! " : 
                     ...
                     (gameVariant == BONK_PATRIOTS) ? "FLAG! " : "TAP! ";
...
void handleGameSelection() {
  ...
  if ((currentTime - stateStartTime) < 100 || 
    ...
    // BONK Bluey option (bottom right) - NEW!
    tft.drawRect(250, 180, 180, 90, CYAN);
    tft.drawRect(251, 181, 178, 88, CYAN);
    tft.fillRect(252, 182, 176, 86, BLUE);
    tft.setTextColor(WHITE);
    tft.setTextSize(2);
